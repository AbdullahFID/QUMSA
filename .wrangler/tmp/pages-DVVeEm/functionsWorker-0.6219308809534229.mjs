...
async function createSession(username, secret, maxAgeSeconds) {
  const payload = b64url(enc.encode(JSON.stringify({ u: username, exp: Date.now() + maxAgeSeconds * 1e3 })));
...
function sessionSetCookie(token, maxAgeSeconds) {
...
async function onRequestPut({ request, env, data }) {
  let body;
  try {
  ...
  if (text.length > 9e5) return json({ error: "Content too large" }, 400);
...
// api/admin/login.js
var SESSION_MAX_AGE = 60 * 60 * 24 * 3;
...
async function onRequestGet2({ data }) {
...
async function onRequestPost3({ request, env, data }) {
  ...
  const base = rawName.slice(0, dot).toLowerCase().replace(/[^a-z0-9_-]+/g, "-").replace(/^-+|-+$/g, "").slice(0, 60) || "image";
...
// api/prayer-times.js
var LATITUDE = 44.2312;
var LONGITUDE = -76.486;
var TUNE = "0,2,-2,1,0,1,0,1,0";
async function onRequestGet3() {
  const [year, month, day] = new Intl.DateTimeFormat("en-CA", {
    timeZone: "America/Toronto"
  }).format(/* @__PURE__ */ new Date()).split("-");
  const url = `https://api.aladhan.com/v1/timings/${day}-${month}-${year}?latitude=${LATITUDE}&longitude=${LONGITUDE}&method=2&tune=${TUNE}`;
...
// api/quran-quotes.js
async function onRequestGet4({ request }) {
...
// ../.wrangler/tmp/pages-DVVeEm/functionsRoutes-0.45557818273048023.mjs
var routes = [
  {
...
// ../../../../Library/Caches/pnpm/dlx/e5f9fc0794d9903bc5875b51b83b3516e044d9294916f24fc81da2057af83899/1a05490da9f-15c3f/node_modules/.pnpm/path-to-regexp@6.3.0/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../Library/Caches/pnpm/dlx/e5f9fc0794d9903bc5875b51b83b3516e044d9294916f24fc81da2057af83899/1a05490da9f-15c3f/node_modules/.pnpm/wrangler@4.127.1/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../../../../Library/Caches/pnpm/dlx/e5f9fc0794d9903bc5875b51b83b3516e044d9294916f24fc81da2057af83899/1a05490da9f-15c3f/node_modules/.pnpm/wrangler@4.127.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../Library/Caches/pnpm/dlx/e5f9fc0794d9903bc5875b51b83b3516e044d9294916f24fc81da2057af83899/1a05490da9f-15c3f/node_modules/.pnpm/wrangler@4.127.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-rTkEr0/middleware-insertion-facade.js
...
// ../../../../Library/Caches/pnpm/dlx/e5f9fc0794d9903bc5875b51b83b3516e044d9294916f24fc81da2057af83899/1a05490da9f-15c3f/node_modules/.pnpm/wrangler@4.127.1/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-rTkEr0/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6219308809534229.mjs.map
