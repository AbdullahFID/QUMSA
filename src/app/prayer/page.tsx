...
export default function Prayer() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-emerald-900 to-teal-900 text-white">
      ...
      <main className="relative -mt-12 bg-white rounded-t-3xl shadow-lg max-w-7xl mx-auto px-6 py-16 sm:py-24 grid lg:grid-cols-4 gap-8">
        {/* Prayer Times Panel */}
        ...
        <div className="space-y-6">
          ...
          <aside className="bg-white rounded-3xl p-6 shadow">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-slate-900">Weekly Events</h3>
            </div>
            <div className="space-y-3">
              {[
